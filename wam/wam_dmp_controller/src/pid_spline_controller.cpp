...
#include <wam_dmp_controller/pid_spline_controller.h>
#include <math.h>
...
namespace wam_dmp_controller
{
    ...
    PIDSplineController::PIDSplineController() {}
    PIDSplineController::~PIDSplineController() {}

    bool PIDSplineController::init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
    {
        PIDController::init(hw, n);

        set_cmd_traj_pos_service_ = n.advertiseService("set_traj_pos_spline",
                                                       &PIDSplineController::set_cmd_traj_spline_srv, this);
        get_cmd_traj_pos_service_ = n.advertiseService("get_traj_pos_spline",
                                                       &PIDSplineController::get_cmd_traj_spline_srv, this);
        go_home_traj_service_ =  n.advertiseService("go_home_traj_spline",
                                                    &PIDSplineController::go_home_traj_spline_srv, this);
        set_gains_service_ = nh_.advertiseService("set_gains", &PIDSplineController::set_gains, this);
        get_gains_service_ = nh_.advertiseService("get_gains", &PIDSplineController::get_gains, this);
    ...
    void PIDSplineController::starting(const ros::Time& time)
    {
        ROS_INFO("PID_SPLINE_CONTROLLER IS RUNNING!!!!!!!!");
        PIDController::starting(time);
        /*
            Important!!!!!!!!!!!!!!!!!!!
    ...
    void PIDSplineController::update(const ros::Time& time, const ros::Duration& period)
    {
        ...
        PIDController::setCommandRT(q_des_, q_dot_des_, q_dotdot_des_);
        PIDController::update(time, period);
    }

    void PIDSplineController::set_default_pos_traj()
    {
    ...
    void PIDSplineController::eval_current_point_to_point_traj(const ros::Duration& period,
    ...
    void PIDSplineController::eval_point_to_point_traj_constants(Eigen::VectorXd& desired_pos,
                                                                        double duration)
    {
    ...
    bool PIDSplineController::set_cmd_traj_spline_srv(wam_dmp_controller::JointPosSpline::Request &req, 
                                                             wam_dmp_controller::JointPosSpline::Response &res)
    {
     ...
     bool PIDSplineController::go_home_traj_spline_srv(wam_dmp_controller::GoHomeSpline::Request &req, 
    ...
    bool PIDSplineController::get_cmd_traj_spline_srv(wam_dmp_controller::JointPosSpline::Request &req,
                                                             wam_dmp_controller::JointPosSpline::Response &res)
    {
        // get translation
    ...
    bool PIDSplineController::set_gains(wam_dmp_controller::SetJointGains::Request &req,
    ...
    bool PIDSplineController::get_gains(wam_dmp_controller::GetJointGains::Request &req,
...
PLUGINLIB_EXPORT_CLASS(wam_dmp_controller::PIDSplineController, controller_interface::ControllerBase)
