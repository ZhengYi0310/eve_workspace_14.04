...
public:
  ...
  //Services
  wam_msgs::BHandGraspVel grasp_vel;
  wam_msgs::BHandSpreadVel spread_vel;
  wam_msgs::Hold hold;
...
void WamTeleop::init()
{
  ...
  //Service Clients
  grasp_vel_srv = nh_.serviceClient<wam_msgs::BHandGraspVel>("grasp_vel");      // /bhand/grasp_vel
  spread_vel_srv = nh_.serviceClient<wam_msgs::BHandSpreadVel>("spread_vel");   // /bhand/spread_vel
  go_home_srv = nw_.serviceClient<std_srvs::Empty>("go_home");                  // /wam/go_home
  hold_srv = nw_.serviceClient<wam_msgs::Hold>("hold_joint_pos");               // /wam/hold_joint_pos
