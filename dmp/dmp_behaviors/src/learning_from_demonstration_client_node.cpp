...
int main(int argc, char** argv)
{
	...
	std::string cartesian_states_bag_name = "cartesian_states_wam.bag";
    ...
    dmp_behaviors::LearningFromDemonstrationClient learning_from_demonstration_client(node_handle, action_name, cartesian_states_bag_name);
