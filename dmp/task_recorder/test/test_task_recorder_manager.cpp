...
#include <task_recorder_utilities/task_recorder_specification_utilities.h>
...
int main(int argc, char** argv)
{
  ...
  std::vector<task_recorder::TaskRecorderSpecification> specifications;
  ROS_VERIFY(task_recorder_utilities::readTaskRecorderSpecification(specifications));
  std::vector<std::string> variable_names;
  ROS_VERIFY(task_recorder_utilities::getAllVariableNames(specifications, variable_names));

  task_recorder::TaskRecorderManagerClient task_recorder_manager_client;
  ...
  ROS_VERIFY(usc_utilities::FileIO<task_recorder::DataSample>::writeToBagFileWithTimeStamps(filtered_and_cropped_messages,
