/*************************************************************************
	> File Name: tf_recorder.cpp
	> Author: Yi Zheng 
	> Mail: hczhengcq@gmail.com
	> Created Time: Mon 26 Jun 2017 09:04:36 PM PDT
 ************************************************************************/
...
{
    TFRecorder::TFRecorder(ros::NodeHandle node_handle) : TaskRecorder<tf::tfMessage>(node_handle), num_transforms_(0)
    {
    ...
    bool TFRecorder::transformMsg(const tf::tfMessage& transform, task_recorder::DataSample& data_sample)
    {
        if(first_time_)
        {
            ...
            ROS_VERIFY(task_recorder_utilities::getIndices(msg_transform_names, transform_names_, indices_));
