...
void MainWindow::on_button_SwitchController_clicked(bool check)
{
    ...
    if(qnode.switch_controllers(start_controller, stop_controller, switch_succeded) && switch_succeded)
    {
        ...
        qnode.set_cartpos_controller_state(start_controller == (robot_name_space + "/operational_space_spline_controller"));
        ...
        if(start_controller == (robot_name_space + "/operational_space_spline_controller"))
        {
