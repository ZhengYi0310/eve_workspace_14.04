/*************************************************************************
	> File Name: base_robot_hw_gazebo_plugin.cpp
	> Author: Yi Zheng 
	> Mail: hczhengcq@gmail.com
	> Created Time: Fri 16 Feb 2018 02:59:15 PM PST
 ************************************************************************/
...
// LWR sim class
#include "sim_hw/base_robot_hw_gazebo.hpp"

namespace sim_hw
{
    class BaseRobotHWsimPlugin : public gazebo::ModelPlugin
    {
        public:
            BaseRobotHWsimPlugin() : gazebo::ModelPlugin() {}
            virtual ~BaseRobotHWsimPlugin()
            {
            ...
            {
                std::cout << "base_robot" << "Loading base_hw plugin" << std::endl;
                ...
                {
                    ROS_FATAL_STREAM_NAMED("base_robot_hw","A ROS node for Gazebo has not been initialized, unable to load plugin. " << "Load the Gazebo system plugin 'libgazebo_ros_api_plugin.so' in the gazebo_ros package)");
                    return;
                }
                ...
                {
                    robot_description_ = "sim_hw/robot_description_yi"; // default
                }
                ...
                robot_hw_sim_.reset(new sim_hw::BaseRobotHWGazebo());
                ...
                update_connection_ =
                gazebo::event::Events::ConnectWorldUpdateBegin(boost::bind(&BaseRobotHWsimPlugin::Update, this));

                ROS_INFO_NAMED("base_robot_hw", "Loaded base_robot_hw."); 
            }
        ...
        private:
            ...
            std::string getURDF(std::string param_name) const
            {
                ...
                ROS_DEBUG_STREAM_NAMED("BaseRobotHWsimPlugin", "Recieved urdf from param server, parsing...");
            ...
            boost::shared_ptr<sim_hw::BaseRobotHWGazebo> robot_hw_sim_;
    ...
    GZ_REGISTER_MODEL_PLUGIN(BaseRobotHWsimPlugin)
 }
