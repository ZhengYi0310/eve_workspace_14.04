#ifndef __BARRETT_MODEL_SIM_HW_H
#define __BARRETT_MODEL_SIM_HW_H
...
#include <barrett_model/cartesian_command_interface.h>
...
{
    class BaseRobotHW: public hardware_interface::RobotHW
    {
        public:
            BaseRobotHW() {}
            virtual ~BaseRobotHW() {}
            ...
            enum ControlStrategy {JOINT_POSITION = 10, CARTESIAN_IMPEDANCE = 20, JOINT_IMPEDANCE = 30, JOINT_EFFORT = 40, JOINT_STIFFNESS = 50, GRAVITY_COMPENSATION = 90, OPERATIONAL_SPACE = 100};
            ...
            // This functions must be implemented depending on the outlet (Real FRI/FRIL, Gazebo, etc.)mZ
            ...
            barrett_model::PositionCartesianInterface position_cart_interface_;
            ...
            // configuration
            static int n_joints_; // for the barret 7 dof arm 
