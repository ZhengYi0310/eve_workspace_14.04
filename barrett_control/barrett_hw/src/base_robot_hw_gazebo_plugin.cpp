...
// LWR sim class
#include "barrett_hw/base_robot_hw_gazebo.hpp"
    ...
    class BaseRobotHWsimPlugin : public gazebo::ModelPlugin
    {
        public:
            ...
            virtual void Load(gazebo::physics::ModelPtr parent, sdf::ElementPtr sdf)
            {
                ...
                robot_hw_sim_.reset(new barrett_hw::BaseRobotHWGazebo());
        ...
        private:
            ...
            boost::shared_ptr<barrett_hw::BaseRobotHWGazebo> robot_hw_sim_;
